...
if(isset($_POST) && !empty($_POST)){
   if ( $_POST['login'] == $login &&  $_POST['password'] == $password ){
    $success = include('./include/success.php');
   }
   else {
    $errors = include('./include/error.php');
   }
}
// echo $success;
// echo "<br>";
    	...
    	<tr>
            ...
            <td class="right-collum-index">
				...
				<div class="index-auth">
                    <form action="./index.php" method="POST" <?=isset($_GET['login']) && $_GET['login'] == "yes"?"": "style='display:none;'"; ?> >
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <?=!empty($errors)?: $errors;?>
							<tr>
								<td class="iat">
